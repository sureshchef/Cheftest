...
(function ($) {
  var DatePicker = function () {
    var ids = {},
      ...
      tpl = {
        wrapper: '<div class="datepicker"><div class="datepickerBorderT" /><div class="datepickerBorderB" /><div class="datepickerBorderL" /><div class="datepickerBorderR" /><div class="datepickerBorderTL" /><div class="datepickerBorderTR" /><div class="datepickerBorderBL" /><div class="datepickerBorderBR" /><div class="datepickerContainer"><table cellspacing="0" cellpadding="0"><tbody><tr></tr></tbody></table>',
        extras: '<div class="side-content"><div class="inner-side-content"><p><strong>Date Range</strong></p><table cellspacing="0" cellpadding="0" class="define-dates"><tr><td class="align-left"><input type="text" class="input-small" id="fromD" name="fromD" placeholder="From"></td><td class="align-vertical">&ndash;</td><td class="align-right"><input type="text" class="input-small" id="toD" name="toD" placeholder="To"></td></tr></table><div class="preset-dates"><ul><li><a class="label week" href="#">Last Week</a></li><li><a class="label month" href="#">Last Month</a></li><li><a class="label quarter" href="#">Last Quarter</a></li><li><a class="label year" href="#">Last Year</a></li></ul></div><button id="reportFilter" class="btn btn-mini btn-info">Apply</button> <button id="cancelFilter" class="btn btn-mini disabled">Cancel</button></div></div>',
        wrapperEnd: '</div></div>',
        head: [
      ...
      init: function(options){
        ...
        return this.each(function(){
          if (!$(this).data('datepicker')) {
            ...
            var cal = $(tpl.wrapper+tpl.wrapperEnd).attr('id', id).bind('click', click).data('datepicker', options);
            if (options.mode == 'range') {
                var cal = $(tpl.wrapper+tpl.extras+tpl.wrapperEnd).attr('id', id).bind('click', click).data('datepicker', options);
            }
