...
Ext.define( 'Ext.ux.GMapPanel', {
    ...
    apiReady : function(){
        ...
        if (this.rendered){
            ...
            (Ext.Function.defer(function(){
                ...
                //binds the onMapReady function to the tilesLoaded event
    ...
    onMapReady : function(){
        ...
        //if(this.markers.length > 0) {this.addMarkers(this.markers);}
    ...
    /**
     * Custom method for creating an Info Window when MouseOver.
     * @param {Object} inwin an Info Window configuration
     * @param {GLatLng} point the point to show the Info Window at
     * @param {GMarker} marker a marker to attach the Info Window to
     */
