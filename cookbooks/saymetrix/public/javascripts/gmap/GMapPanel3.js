...
markers: [{
    ...
    initComponent : function(){
        this.addEvents(
            ...
            /**
             * @event markersloaded
             * Fires when all the markers have been added
             */
            'markersloaded'
        );
        ...
        if (window.google && window.google.maps){
          ...
          this.buildScriptTag('https://maps-api-ssl.google.com/maps/api/js?sensor=false&callback=gmapapiready');
        }
          ...
          Ext.defer(function(){
              ...
              if (typeof this.setCenter === 'object') {
                  if (typeof this.setCenter.geoCodeAddr === 'string'){
                      ...
                      if (this.gmapType === 'map' || this.gmapType === 'satellite'){
    ...
    onMapReady : function(){
        ...
        //after this.addMarkers(...) all of the markers on the map are actually store in this.cache.marker
        //the this.markers array still refers to our custom objects.
    ...
    onResize : function(w, h){
        ...
        if (typeof this.getMap() == 'object') {
            ...
            if (this.lastCenter){
                //this line has been commented out because it would reset the map's center to the original one specified during start up.
//              this.getMap().setCenter(this.lastCenter, this.zoomLevel);
    ...
    addMarker : function(point, marker, clear, center, listeners){
        ...
        var mark = new google.maps.Marker(Ext.apply(marker, {
            position: point,
            icon: rootFolder+"/public/images/map-icons/markers/"+marker.type+".png",
            shadow: shadow,
            visible: false
        }));
        ...
        if (marker.infoBubble){
            this.createInfoBubble(marker.infoBubble, point, mark);
        }
    ...
    createInfoBubble : function(infoConfig, point, marker){ 
